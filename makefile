...
WXCORE-HCFLAGS	=$(HCFLAGS) $(PKG-BYTESTRING) $(PKG-CONTAINERS) $(PKG-FILEPATH) $(PKG-STM) -package-name $(WXCORE)-$(VERSION)
...
WX-HCFLAGS	=$(HCFLAGS) $(PKG-STM) -package-name $(WX)-$(VERSION) -package $(WXCORE)-$(VERSION)
