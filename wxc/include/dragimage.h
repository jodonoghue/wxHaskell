...
TClass(wxGenericDragImage)  wxGenericDragImage_Create( TClass(wxCursor) cursor, int x, int y );
TClass(wxGenericDragImage)  wxGenericDragIcon( TClass(wxIcon) icon, int x, int y );
TClass(wxGenericDragImage)  wxGenericDragString( TClass(wxString) test, int x, int y );
